    ...
    view! {cx,
          <div class="w-full">
            <nav class="container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:justify-between xl:px-0">
               <div class="flex flex-wrap items-center justify-between w-full lg:w-auto">
                  <a href="/">
                    <span class="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                      <span>
                        <img alt="N" loading="lazy" width="32" height="32" decoding="async" data-nimg="1" class="w-8" style="color:transparent" src="/assets/logo.jpg"/>
                      </span>
                      <span>
                        Aviabird
                      </span>
                  ...
                  <div class="flex flex-wrap w-full my-5 lg:hidden" class:hidden=move || !mobile_menu()>
                    ...
                    <a class="px-6 py-2 mt-2 text-white text-center bg-indigo-600 rounded-md md:ml-5 w-full" href="/contact/hire-us">
                      Get Started
                    </a>
                  </div>
               </div>
               ...
               <button
                    on:click=move |_| dark_mode.update(|value| *value = !*value)
                >
                  <i class="fa-solid fa-sun fa-xl w-8"
                    class:fa-moon=move || !dark_mode() 
